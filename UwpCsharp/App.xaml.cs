...
namespace UwpCsharp
{
    ...
    sealed partial class App : Application
    {
        ...
        {
            SentrySdk.ConfigureScope(s => s.AddBreadcrumb("launched"));
        ...
        void OnNavigationFailed(object sender, NavigationFailedEventArgs e)
        {
            SentrySdk.WithScope(s =>
            {
                s.AddBreadcrumb(
                    ...
                    category: "navigation",
                    type: "navigation",
                    dataPair: (nameof(e.SourcePageType), e.SourcePageType.ToString()));
        ...
        private void OnSuspending(object sender, SuspendingEventArgs e)
        {
            ...
            SentrySdk.AddBreadcrumb("Suspending app.");

            // TODO: Does this block the UI thread?
